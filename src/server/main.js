...
app.post("/suggest", async (req, res) => {
  ...
  try {
    ...
    const options = {
      ...
      projection: { _id: 0, "scheme_details.title_name": 1, description: 1 ,"scheme_details.benefits_types": 1,"scheme_details.beneficiaries": 1,how_to_avail: 1,"scheme_details.sponsored_by":1,"scheme_details.funding_pattern":1 },
    };
